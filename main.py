...
from data_manager import save_result_data, save_avg_result_data
...
def get_command_line_args():
    ...
    parser.add_argument("--number_interlaced", type=int, help="Number of interlaced simulations", default=number_interlaced)
...
# This is redundant if defaults are set in the parser, as argparse will use the default value if not specified by the user
if args.info:
...
if __name__ == '__main__':
    ...
    for concentration, thickness in parameter_list:
        # Calculate bath radius and dipole radius based on concentration
        ...
        for i in range(no_systems):
            ...
            results.append(final_time_prob)  # Collect results for all concentrations
